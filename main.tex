...
\headedsection
  ...
  \headedsubsection
    ...
    We demonstrated that some of the techniques we use to avoid over-fitting also yield better adversarial robustness and that model architecture should be informed keeping these considerations in mind.\\
    GPA 7.8/10}}
}
\vspace{1em}
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{\begin{itemize}
	    \item[\ding{111}] Scored $91.2\%$ in CBSE 10th Standard.
	    \item[\ding{111}] scored $92\%$ in Senior Secondary exams (12th Standard).
		...
		\item[\ding{111}] Trained for olympiads and selected for the Indian National Olympiad in Informatics.
    \end{itemize}}}
}
\vspace{1em}
...
\headedsection
  ...
  \headedsubsection
    ...
    {Submitted to IEEE TNNLS;  March 7,2023}{}
}
\vspace{1em}
...
\headedsection{\textbf{Deep Analysis of Pain Management}}{Jun \apo20 -- Nov \apo20}{
    \bodytext{Collaborated with medical professionals in the field of radio diagnosis to formulate a problem statement and set up data gathering protocols to create a high quality data set for analysis of back pain from MRI images.}}
...
\headedsection{\textbf{Teaching and Presentations}}{}{\bodytext{\begin{itemize}
	\item[\ding{111}] Instructor at the Winter School of Deep Learning (WSDL) (2021, 2022).
	\item[\ding{111}] Insturctor for the Comprehensive Course on Business Analytics.
	\item[\ding{111}] TA for Natural Language Processing course at Indian Statistical Institute, Kolkata.
	\item[\ding{111}] Presented at Amazon Research Days (ARD \apo22)
\end{itemize}}}
...
\roottitle{Skills}
	 ...
	 \ding{111} In addition to being well-versed in supervised, semi-supervised and unsupervised training paradigms also familiar with techniques like \textbf{adversarial training, fine-tuning, transfer learning, prompting, distillation, etc}.\\
