...
\\
\\
	I am currently a $4^{th}$ year PhD candidate at the \href{https://cvpru.isical.ac.in/}{Computer Vision and Pattern Recognition Unit}, \href{https://www.isical.ac.in/}{\textbf{Indian Statistical Institute, Kolkata}} working under the supervision of \textbf{\href{https://www.isical.ac.in/~utpal}{Prof. Utpal Garain}}.
\end{multicols}
...
\vspace{0.6em}
\headedsection
  {\ding{111} \href{https://doi.org/10.1162/coli_a_00493}{Analyzing Semantic Faithfulness of Language Models via Input Intervention on Conversational Question Answering}}
...
\vspace{0.6em}
\headedsection
  {\ding{111} \href{https://arxiv.org/abs/2311.12610}{ChessVision -- A Dataset for Logically Coherent Multi-label Classification}}
  {\textbf{S. Saha}, U. Garain} {%
  \headedsubsection
    {arXiv preprint, \normalfont{10.48550/arXiv.2311.12610}}
    {}{}
}
\vspace{1em}
...
\headedsection{\textbf{Teaching and Presentations}}{}{\bodytext{\begin{itemize}
	...
	\item[\ding{111}] TA for Natural Language Processing course at ISI Kolkata (2022, 2023).
	\item[\ding{111}] Presented my work on Logically Coherent Deep Learning at Amazon Research Days (ARD \apo22)
	\item[\ding{111}] Conducted training session on Large Language Models at Data Labs, CapitalOne Bangalore.
\end{itemize}}}
